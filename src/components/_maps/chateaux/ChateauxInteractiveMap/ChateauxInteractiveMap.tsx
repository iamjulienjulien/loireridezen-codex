...
import {
    CHATEAUX_MAP_CONFIG,
    type ChateauxMapFloatingPosition,
    type ChateauxMapStickyMode,
} from "@/components/_maps/chateaux/config";
...
type ChateauxInteractiveMapProps = {
    ...
    stickyMode?: ChateauxMapStickyMode;
    floatingPosition?: ChateauxMapFloatingPosition;
};

type DragPosition = { x: number; y: number };
type MapSize = { width: number; height: number };
type ChateauxMapStyle = CSSProperties & {
...
export default function ChateauxInteractiveMap({
    ...
    floatingPosition = CHATEAUX_MAP_CONFIG.floating.position,
