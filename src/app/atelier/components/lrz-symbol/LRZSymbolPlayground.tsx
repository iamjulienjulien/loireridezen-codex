...
type LRZSymbolPlaygroundProps = {
    ...
    commonGeneralOptions: readonly LRZSymbolPlaygroundOption<LRZCommonGeneralSymbolSlug>[];
    commonTerritoireOptions: readonly LRZSymbolPlaygroundOption<LRZCommonTerritoireSymbolSlug>[];
    commonWebsiteOptions: readonly LRZSymbolPlaygroundOption<LRZCommonWebsiteSymbolSlug>[];
    ...
    guinguetteActiviteOptions: readonly LRZSymbolPlaygroundOption<LRZGuinguetteActiviteSymbolSlug>[];
    ...
    vignobleCepageOptions: readonly LRZSymbolPlaygroundOption<LRZVignobleCepageSymbolSlug>[];
