        ...
        <>
            ...
            <div className={styles.wrap}>
                ...
                <section
                    ...
                    aria-labelledby="timeline-props"
                >
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <code>LRZTimelineItem[]</code>
                                    </td>
                                    <td>
                                        Événements, dates, titres et contenus de
                                        la frise.
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <code>line | cards | compact</code>
                                    </td>
                                    <td>
                                        Trait éditorial, cartes ou lecture
                                        dense.
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Densité typographique et espacements.
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                    ...
                                    <td>
                                        Couleur CSS de la ligne et des repères.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
