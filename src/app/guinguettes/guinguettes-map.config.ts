...
export type GuinguettesMapStickyMode = "floating" | "compact";
export type GuinguettesMapFloatingPosition =
    "inline" | "top-right" | "top-left" | "bottom-right" | "bottom-left";

export const GUINGUETTES_MAP_FLOATING_POSITIONS = [
    {
        id: "inline",
    ...
    id: GuinguettesMapFloatingPosition;
    label: string;
    description: string;
}>;
...
export const GUINGUETTES_MAP_CONFIG = {
    stickyMode: "floating" as GuinguettesMapStickyMode,
    floating: {
        position: "top-right" as GuinguettesMapFloatingPosition,
        dimensions: {
            width: 400,
            height: 288,
            minWidth: 288,
    ...
    defaultView: {
        center: [0.25, 47.4] as [number, number],
        zoom: 6,
        resetDuration: 350,
    },
    catalogueFit: {
...
export const GUINGUETTES_MAP_PALETTES: Record<Ambiance, MapPalette> = {
    aube: {
        water: "#dde6e8",
        land: "#f5ead8",
        forest: "#c8c8b0",
